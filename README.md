...
Example command:
```
java -jar LanraragiFakkuTagger-1.10.jar <lanraragi_api_key> <lanraragi link, something like http://127.0.0.1> <fakku_sid_cookie> <koromo or koharu> <amount to process, 0 for all> <offset to start with, defaults to 0>
```
